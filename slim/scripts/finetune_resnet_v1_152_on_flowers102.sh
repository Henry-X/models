...
# Usage:
# cd slim
# ./slim/scripts/finetune_resnet_v1_152_on_flowers.sh
set -e
...
TRAIN_DIR=/tmp/flowers-models/resnet_v1_152
...
if [ ! -f ${PRETRAINED_CHECKPOINT_DIR}/resnet_v1_152.ckpt ]; then
  wget http://download.tensorflow.org/models/resnet_v1_152_2016_08_28.tar.gz
  tar -xvf resnet_v1_152_2016_08_28.tar.gz
  mv resnet_v1_152.ckpt ${PRETRAINED_CHECKPOINT_DIR}/resnet_v1_152.ckpt
